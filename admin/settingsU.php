          ...
          <?php 
            ...
            if($res==TRUE){
                ...
                if($count==1){
                    ...
                    header('location:' .SITEURL. 'admin/settingsU.php');
                    exit();
                }
            }
                    ...
                    <div class="rowsDiv">
                      ...
                      <div class="row">
                       ...
                       <div class="row">
                        ...
                        <input type="text" id="currentPassword" name="currentPassword"  placeholder="Enter Your Current Password">
                        <input type="hidden" id="currPassword" name="currPassword" value="<?php echo $adminPassword;?>" placeholder="Enter Your Current Password" required>
                       </div>
