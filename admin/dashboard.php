          ...
          <div class="bodyContainer flex">
            ...
            <div class="mainSection flex">
              ...
              <div class="salesDiv">
                ...
                <?php 
                 $sql = "SELECT totalPrice from orders WHERE orderStatus = 'delivered'";
                 ...
                 if($res == TRUE){
                  ...
                  if($count > 0)
                  {
                    while ($row = mysqli_fetch_assoc($res)){
                      $eachItemPrice = $row['totalPrice'];
                        $totalSales += $eachItemPrice;
                    }
                ...
                ?>
                <div> <h1>$ <?php echo $totalSales?></h1></div>
                      ...
                      ?>
                        ...
                        <div class="itemInfo">
                          ...
                          <div class="itemBottom flex">
                            ...
                            <a href="menu.php"><i class="uil uil-newspaper icon"></i></a>
                          </div>
                        </div>
                      </div>
                      <?php
