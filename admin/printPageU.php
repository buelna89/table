...
<div class="prevIcon flex">
    <a href="<?php echo SITEURL?>admin/orderDetailsU.php?id=<?php echo $orderID?>"><i class="uil uil-angle-left icon"></i></a>
</div>
